...
let employee = HourlyEmployee(name: "Karthik", address: "someAddress", startDate: Date(), type: .traditional)
...
class Milk: Dairy, Blendable {
    func blend() {
        print("I haven't changed at all! I'm still milk fam!")
    }
}
...
let cheese = Cheese(name: "Chedder")
